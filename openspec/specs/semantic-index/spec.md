...
> Estado: propuesto (se implementa en `changes/0003-semantic-index`). Este archivo se
...
- **THEN** el sistema responde `404 Not Found` o una lista vacía (a decidir al
  implementar; documentar la elección en `design.md` si difiere de lo aquí escrito)
